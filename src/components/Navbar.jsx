...
const Navbar = ({ onSelectCategory, onSearch }) => {
  ...
  const fetchData = async (value) => {
    try {
      const response = await axios.get("https://dino-mart.onrender.com/api/products");
  ...
  const handleChange = async (value) => {
    ...
    try {
      const response = await axios.get(
        `https://dino-mart.onrender.com/api/products/search?keyword=${value}`
      );
      setSearchResults(response.data);
      ...
      <header>
        <nav className="navbar navbar-expand-lg fixed-top">
          <div className="container-fluid">
            <a className="navbar-brand" href="www.linkedin.com/in/rahul-tank-1331a9261">
              Dino-Mart
            </a>
            <button
